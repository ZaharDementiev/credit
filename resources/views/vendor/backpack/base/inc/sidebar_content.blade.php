<li class="nav-item"><a class="nav-link" href="{{ backpack_url('dashboard') }}"><i class="nav-icon la la-file-contract"></i> <span>Контакты</span></a></li>
<li class="nav-item"><a class="nav-link" href="{{ backpack_url('moneyboard') }}"><i class="nav-icon la la-money-bill-wave"></i> <span>Деньги</span></a></li>
