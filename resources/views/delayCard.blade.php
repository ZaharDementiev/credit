    ...
    <section class="callBack">
        <div class='container'>
            <div class="callBack__form">
                <h2>ОТВЯЗАТЬ БАНКОВСКУЮ КАРТУ</h2>
                <p>Чтобы отвязать вашу банковскую карту, пожалуйста введите номер ее </p>
                <form action="" class="form cardBox">
                    <div class="text">Номер банквоской карты <span>*</span></div>

                    <div class="cardBox__group">
                        <label>Номер карты</label>
                        <input type="tel" name="card" placeholder="0000    0000    0000    0000" id="delayCard">
                    </div>
